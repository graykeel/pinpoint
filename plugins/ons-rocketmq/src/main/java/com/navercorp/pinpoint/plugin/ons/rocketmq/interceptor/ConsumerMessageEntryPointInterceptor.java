...
package com.navercorp.pinpoint.plugin.ons.rocketmq.interceptor;
...
import com.navercorp.pinpoint.plugin.ons.rocketmq.RocketMQConstants;
import com.navercorp.pinpoint.plugin.ons.rocketmq.description.EntryPointMethodDescriptor;
    ...
    private static class TraceFactoryProvider {
        ...
        private static class DefaultTraceFactory implements TraceFactory {
            ...
            private String createRpcName(SpanRecorder recorder, String topic, List<MessageExt> msgs) {
                final StringBuilder rpcName = new StringBuilder("osn-rocketmq://");
