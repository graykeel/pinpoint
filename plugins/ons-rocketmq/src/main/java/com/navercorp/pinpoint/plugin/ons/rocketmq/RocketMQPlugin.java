 ...
 */
package com.navercorp.pinpoint.plugin.ons.rocketmq;
...
import com.navercorp.pinpoint.plugin.ons.rocketmq.field.accessor.ChannelFutureGetter;
import com.navercorp.pinpoint.plugin.ons.rocketmq.field.accessor.ChannelTablesAccessor;
import com.navercorp.pinpoint.plugin.ons.rocketmq.field.accessor.ChannelTablesGetter;
import com.navercorp.pinpoint.plugin.ons.rocketmq.field.accessor.EndPointFieldAccessor;
import com.navercorp.pinpoint.plugin.ons.rocketmq.field.accessor.MQClientInstanceGetter;
import com.navercorp.pinpoint.plugin.ons.rocketmq.interceptor.ConsumerMessageListenerConcurrentlyInterceptor;
import com.navercorp.pinpoint.plugin.ons.rocketmq.interceptor.ConsumerMessageListenerOrderlyInterceptor;
import com.navercorp.pinpoint.plugin.ons.rocketmq.interceptor.DefaultMQPushConsumerImplStartInterceptor;
import com.navercorp.pinpoint.plugin.ons.rocketmq.interceptor.ProducerSendCallBackInterceptor.ConstructInterceptor;
import com.navercorp.pinpoint.plugin.ons.rocketmq.interceptor.ProducerSendCallBackInterceptor.OnExceptionInterceptor;
import com.navercorp.pinpoint.plugin.ons.rocketmq.interceptor.ProducerSendCallBackInterceptor.OnSuccessInterceptor;
import com.navercorp.pinpoint.plugin.ons.rocketmq.interceptor.ProducerSendInterceptor;
import com.navercorp.pinpoint.plugin.ons.rocketmq.interceptor.UpdateNameServerAddressListInterceptor;
...
public class RocketMQPlugin implements ProfilerPlugin, MatchableTransformTemplateAware {
    ...
    public void setup(ProfilerPluginSetupContext context) {
        ...
        basePackageNames.add("com.aliyun.openservices");
        basePackageNames.add("com.test");
        basePackageNames.add("com.banniuyun");
        basePackageNames.add("com.bytenew");
        basePackageNames.add("wangjubao");
        basePackageNames.add("banniu");
        ...
        if (config.isProducerEnable()) {
            transformTemplate.transform("com.aliyun.openservices.shade.com.alibaba.rocketmq.client.impl.MQClientAPIImpl",
            ...
            final Matcher matcher = Matchers.newPackageBasedMatcher(basePackageNames,
                                                                    new InterfaceInternalNameMatcherOperand(
                                                                            "com.aliyun.openservices.ons.api.SendCallback",
                                                                            true));
            transformTemplate.transform(matcher, SendCallbackTransform.class);
        }

        if (config.isConsumerEnable()) {
            transformTemplate.transform("com.aliyun.openservices.shade.com.alibaba.rocketmq.client.impl.consumer.DefaultMQPushConsumerImpl",
                                        ConsumerTransform.class);
            transformTemplate.transform("com.aliyun.openservices.shade.com.alibaba.rocketmq.remoting.netty.NettyRemotingClient",
                                        RemotingTransform.class);
            transformTemplate.transform("com.aliyun.openservices.shade.com.alibaba.rocketmq.remoting.netty.NettyRemotingClient$ChannelWrapper",
                                        ChannelWrapperTransform.class);
            final Matcher matcher = Matchers.newPackageBasedMatcher(basePackageNames,
                                                                    new InterfaceInternalNameMatcherOperand(
                                                                            "com.aliyun.openservices.shade.com.alibaba.rocketmq.client.consumer.listener.MessageListenerConcurrently",
                                                                            true));
            ...
            final Matcher orderlyMatcher = Matchers.newPackageBasedMatcher(basePackageNames,
                                                                           new InterfaceInternalNameMatcherOperand(
                                                                                   "com.aliyun.openservices.shade.com.alibaba.rocketmq.client.consumer.listener.MessageListenerOrderly",
                                                                                   true));
    ...
    public static class SendCallbackTransform implements TransformCallback {
        ...
        public byte[] doInTransform(Instrumentor instrumentor, ClassLoader classLoader, String className,
            ...
            final InstrumentMethod onExceptionsMethod = target.getDeclaredMethod("onException",
                                                                                 "com.aliyun.openservices.ons.api.OnExceptionContext");
    ...
    public static class MessageListenerConcurrentlyTransform implements TransformCallback {
        ...
        public byte[] doInTransform(Instrumentor instrumentor, ClassLoader classLoader, String className,
            ...
            final InstrumentMethod consumeMessageMethod = target.getDeclaredMethod("consumeMessage",
                                                                                   "java.util.List",
                                                                                   "com.aliyun.openservices.shade.com.alibaba.rocketmq.client.consumer.listener.ConsumeConcurrentlyContext");
    ...
    public static class MessageListenerOrderlyTransform implements TransformCallback {
        ...
        public byte[] doInTransform(Instrumentor instrumentor, ClassLoader classLoader, String className,
            ...
            final InstrumentMethod consumeMessageMethod = target.getDeclaredMethod("consumeMessage",
                                                                                   "java.util.List",
                                                                                   "com.aliyun.openservices.shade.com.alibaba.rocketmq.client.consumer.listener.ConsumeOrderlyContext");
